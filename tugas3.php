...
<head>
    ...
    <style>
        ...
        th {
            background-color: #0288d1; /* Warna biru untuk header */
            color: white;
        }
        form {
            margin: 20px auto;
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="" style="display: inline;">
                            ...
                            <button type="submit" onclick="return confirm('Yakin ingin menghapus post ini?');">Hapus</button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
